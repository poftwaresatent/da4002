...
\centerline{\includegraphics[width=0.6\columnwidth]{q3-graphs.pdf}}
...
It is possible to compute the spanning tree by tracing the execution of depth-first search (DFS):
