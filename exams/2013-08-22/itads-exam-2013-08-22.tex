...
The \texttt{calc} function is a straightforward but very inefficient recursive implementation to compute that sequence.
...
\verbatimtabinput{q5a.c}
\verbatimtabinput{q5b.c}
