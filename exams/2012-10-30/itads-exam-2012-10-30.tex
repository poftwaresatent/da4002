...
The Needleman-Wunsch algorithm, which has been studied in detail suring project 2, can be used to align different kinds of sequences.
...
\item
  What is the optimal alignment cost between these two sequences?
\item
