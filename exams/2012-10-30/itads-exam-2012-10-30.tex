...
\item
  The time it takes to run \texttt{function\_one} in the fragment below for $N=273654$ is $T_1(N) = 35762$.
  Based on a big-Oh complexity analysis, how much time will it take for $N'=83764$?
  You can assume that the various \texttt{slow\_X} functions take significantly longer to execute than any of the other instructions in the code.
