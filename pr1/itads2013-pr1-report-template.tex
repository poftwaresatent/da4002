...
\small\noindent
\verbatiminput{examples/msort-example.plot}
\normalsize
...
\small\noindent
\verbatiminput{examples/msort-example-NlogN.plot}
\normalsize
...
\small\noindent
\verbatiminput{examples/isort-msort-together.plot}
\normalsize
...
\small\noindent
\verbatiminput{examples/isort-msort-together-logscale.plot}
\normalsize
